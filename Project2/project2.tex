...
We then test both logistic regression and the NN on the cancer data from \texttt{sklearn}. This data-set consist of 572 samples, each of which contains 30 features. Due to us using $25\%$ of our data for testing, we thus have $143$ test-points to work with.
