...
\end{subequations}
% \begin{align}
% 	\delta_{N} &= \delta^{\text{out}}_{n} \frac{\partial l(y_N, \tilde{y}_N)}{\partial \tilde{y}_N},\\
% 	\delta_{N-1} &= \left( \delta^{\text{out}}_{n} + \delta_{N}W_{hh}^T\right)\odot \sigma'_{h}(z_N),\\
% 	&\dots \\
% 	\delta_{1} &= \left( \delta^{\text{out}}_{n} + \delta_{2}W_{hh}^T\right)\odot \sigma'_{h}(z_{2})
% \end{align}
