...
\begin{abstract}
	...
	\color{red}I find it weird that we are supposed to be writing the abstract before actually concluding all the results. In general the abstract should be written last...shouldn't it?\color{black}
\end{abstract}
