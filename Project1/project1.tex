...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{Python/Figures/OLS/OLS_MSEMINMAX.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{Python/Figures/OLS/OLS_MSEStandardScaling.pdf}
	\caption{The MSE of train (solid) and test (dashed) data from the OLS regression method using data generated by \(N=100\) datapoints from the Franke function in \eqref{eq:franke}, with noise proportional to \(\epsilon=0.1\). The y-axis is logarithmic, and the x-axis gives the polynomial degree \(p\in[0,17]\). Standard scaling has been applied to the data.}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{Python/Figures/CV/CV_0.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{Python/Figures/CV/CV_1.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{Python/Figures/CV/CV_2.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{Python/Figures/CV/CV_3.pdf}
