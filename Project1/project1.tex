...
We did not spend time making these plots look nice nor fix captions for them but hopefully the titles are explanatory enough. Note that for the predicted versions of the terrain data we have used StandardScaling whilst the actual terrain file is not.
\begin{figure}[H]
	\includegraphics[width=0.44\textwidth]{Python/Figures/Terrain/Ridge_franke_Unscaled_3D.pdf}
\end{figure}
\begin{figure}[H]
	\includegraphics[width=0.44\textwidth]{Python/Figures/Terrain/Ridge_Grand Canyon_StandardScaling_actual.pdf}
\end{figure}
\begin{figure}[H]
	\includegraphics[width=0.44\textwidth]{Python/Figures/Terrain/Ridge_Grand Canyon_StandardScaling.pdf}
\end{figure}
\begin{figure}[H]
	\includegraphics[width=0.44\textwidth]{Python/Figures/Terrain/Ridge_Grand Canyon_StandardScaling_actual_3D.pdf}
\end{figure}
\begin{figure}[H]
	\includegraphics[width=0.44\textwidth]{Python/Figures/Terrain/Ridge_Grand Canyon_StandardScaling_3D.pdf}
\end{figure}
\begin{figure}[H]
	\includegraphics[width=0.44\textwidth]{Python/Figures/Terrain/Ridge_Mount Everest_StandardScaling_actual.pdf}
\end{figure}
\begin{figure}[H]
	\includegraphics[width=0.44\textwidth]{Python/Figures/Terrain/Ridge_Mount Everest_StandardScaling.pdf}
\end{figure}
\begin{figure}[H]
	\includegraphics[width=0.44\textwidth]{Python/Figures/Terrain/Ridge_Mount Everest_StandardScaling_actual_3D.pdf}
\end{figure}
\begin{figure}[H]
	\includegraphics[width=0.44\textwidth]{Python/Figures/Terrain/Ridge_Mount Everest_StandardScaling_3D.pdf}
\end{figure}
