...
On the terrain data we still see that OLS and Ridge outperform LASSO, but all regression models perform much better than expected. This is likely due to mistakes in the code which we were unable to detect.
